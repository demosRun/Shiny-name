owo.tool.notice = function (text, config) {
  ...
  remind.style.cssText = 'position: fixed;right: -200px;bottom: 5%;background-color: #009fe9;color: white;padding: 5px 10px;border-radius: 5px 0 0 5px;width: 180px;transition: right 0.6s, opacity 0.6s;font-size: 16px;line-height: 1.6;cursor: pointer;box-shadow: rgb(87, 110, 195) 1px 2px 7px'
